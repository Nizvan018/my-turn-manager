...
export default function TurnsSection() {
    return (
        <section className="overflow-y-hidden flex flex-col gap-6 w-[420px] h-full p-6 rounded-[48px] border border-curious-blue-950/10 bg-curious-blue-950/5 backdrop-blur-sm">
